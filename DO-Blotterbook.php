                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-1">
                                                <a href="DO-Blotterbookadd.php" class="btn btn-primary mb-3"><i class="fa fa-plus" aria-hidden="true"></i> Add Record</a>
                                            </div>
                                            <div class="col-sm-9">
                                                <h2 class="header-title text-center">POLICE BLOTTER LIST</h2>       
                                            </div> 
                                            <div class="col-sm-2">
                                                <a href="DO-Blotterbookrecovery.php" class="btn btn-danger ml-5"><i class="fa fa-recycle" aria-hidden="true"></i> Data Recovery</a>
                                            </div>   
                                        </div>
                                    </div>
                                    ...
                                    <thead class="bg-my-secondary text-light">
                                        <tr>
                                            ...
                                            <th class="text-center col-sm-2">Disposition</th>
                                    ...
                                    <tbody>
                                       <?php
                                        ...
                                        $table = mysqli_query($conn,'SELECT * FROM tbl_blotter WHERE bdeleted = "No"');
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $row["bdisposition"]; ?></td>
                                                <td class="text-center"><?php echo $row["bstatus"]; ?></td>
                                                <td class="text-center">
                                                    <ul class="d-flex justify-content-center">
                                                        <form action="code.php" method="POST">
                                                            <input type="hidden" name="pbpassdataid" value="<?php echo $row["entryno"]; ?>">
                                                            <button class="mr-3 border-0 text-primary" name="pbpassdatabtn" type="submit"><i class="fa fa-edit"></i> Edit</button>
                                                        </form>
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="pbdelete_id" id="delete_id">
                        <p>Are you sure to delete data?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="pbdeletedata" id="deletedata" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
