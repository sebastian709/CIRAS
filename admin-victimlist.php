                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h2 class="header-title text-center">Victim List</h2>    
                                            </div>
                                            <div class="col mb-4">
                                                <a href="admin-victimrecover.php" class="btn btn-success pull-right"><i class="fa fa-recycle" aria-hidden="true"></i> Data Recovery</a>         
                                            </div>
                                        </div>
                                    </div>
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_victim WHERE vdeleted = "No"');
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <form action="code.php" method="POST">
                                                            <input type="hidden" name="vpassdataid" value="<?php echo $row["id"]; ?>">
                                                            <button class="mr-3 border-0 text-primary" name="vpassdatabtn" type="submit"><i class="fa fa-edit"></i> Edit</button>
                                                        </form>
