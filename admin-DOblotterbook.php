                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="admin-DOblotterbook.php"><i class="fa fa-book text-light" aria-hidden="true"></i> <span>Blotter Book</span></a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Blotter Book</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Blotter List</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <thead class="bg-my-secondary text-light">
                                        <tr>
                                            <th class="text-center col-sm-2">Enty No.</th>
                                            <th class="text-center col-sm-2">Date & Time</th>
                                            <th class="text-center">Incidenttals/Events</th>
                                    ...
                                    <tbody>
                                       <?php
                                        ...
                                        $table = mysqli_query($conn,'SELECT * FROM tbl_blotter WHERE bdeleted="No" AND bstatus = "Pending"');
                                                ...
                                                <td class="text-center">  
                                                    <ul class="d-flex justify-content-center">
                                                        <form action="code.php" method="POST">
                                                            <input type="hidden" name="proceedirfid" value="<?php echo $row["entryno"]; ?>">
                                                            <button class="mr-3 border-0 text-success" name="proceedirfbtn" type="submit">Proceed to IRF <i class="fa fa-arrow-right" aria-hidden="true"></i></button>
                                                        </form>
                                                    </ul>
                                                </td>
