...
<body onload="startTime()">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col bg-my-secondary">
                                            <p class="text-center font-weight-bold  text-warning ">Step 2: Suspect Data</p>
                                        </div>
                                        <div class="col bg-light border border-dark">
                            ...
                            <div class="card">
                                <div class="card-body">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col">
                                                    <button  class="btn btn-success restorebtn font-weight-bold"><i class="fa fa-plus" aria-hidden="true"></i> Add Suspect</button>
                                                </div>
                                                <div class="col mb-5">
                                                    <h4 class="text-center">Suspect Data</h4>   
                                                </div>
                                                <div class="col">
                                    ...
                                    <form action="code.php" method="POST">
                                                    ...
                                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                $table = mysqli_query($conn,'SELECT * FROM tbl_suspect WHERE sdeleted = "No" AND investigno = "IS-'.$smyid.'"');
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <ul class="d-flex justify-content-center">
                                                                        <li class="mr-3"><a href="#" class="text-danger deletebtn"><i class="ti-trash"></i> Remove </a></li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
                                                                <?php
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <p class="pull-right mt-5 text-danger font-weight-bold">*Note: Skip this if there is no suspect.</p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col mt-4 form-group">
                                                    <form action="code" method="POST">
                                                        <input type="hidden" value="IS-<?php echo $user["entryno"]; ?>" name="backid">
                                                        <button class="btn btn-danger form-control font-weight-bold" type="submit" name="backtoedit"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back</button>    
                                                    </form>
                                                </div>
                                                <div class="col mt-4 form-group">
                                                    <form action="code.php" method="POST">
                                                        <input type="hidden" value="<?php echo $user["entryno"]; ?>" name="ibnextno">
                                                        <button class="btn btn-primary form-control font-weight-bold" type="submit" name="itembbtn">Next <i class="fa fa-angle-right" aria-hidden="true"></i></button> 
                                                    </form>
                                                </div>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="evdelete_id" id="delete_id">
                        <p>Are you sure you want to remove data?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="rvdeletedata" id="deletedata" class="btn btn-danger">Remove Suspect</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade bd-example-modal-xl" id="restoremodal" tabindex="-1" role="dialog" aria-labelledy="exampleModallabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="text-center">ADD SUSPECT : IS-<?php echo $user["entryno"]; ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="code.php" method="POST">
                                ...
                                <div class="col">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="smidname">
                                        </div>
                                    </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Nickname</label>
                                        <input type="text" class="form-control" name="snickname">
                                    </div>
                                </div>  
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="sbirthday" placeholder="mm-dd-yyyy" value="" min="1899-01-01" max="2030-12-31" id="from-datepicker">
                                    </div>
                                </div>
                                <div class="col-sm-1">
                                    <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="smobileno">
                                    </div>
                                </div>   
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="scitizen">
                                    </div>    
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Place of Birth</label>
                                        <input type="text" class="form-control" name="splaceofbirth">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="shigheduc">
                                            <option>Choose...</option>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="soccu">
                                    </div>    
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Work Address</label>
                                        <input type="text" class="form-control" name="sworkadd">
                                    </div>    
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="suspectsave" id="restoredata" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add Suspect</button>
                    </div>
                </form>
            </div>
        </div>
