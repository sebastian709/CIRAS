        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <h3 class="mt-5 text-center">Add Suspect</h3>
                    ...
                    <div class="row">
                        <div class="col mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="header-title text-center">Suspect Data</h2>
                                    <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="slastname1">
                                                    </div>    
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>First name</label>
                                                        <input type="text" class="form-control" name="sfirstname1">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Middle name</label>
                                                        <input type="text" class="form-control" name="smidname1">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Nickname</label>
                                                        <input type="text" class="form-control" name="snickname1">
                                                    </div>
                                                </div>  
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control h-100" name="scivilstatus1">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        <label>Gender</label>
                                                        <select class="form-control h-100" name="sgender1">
                                                            <option>Choose...</option>
                                                            <option>Male</option>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="sbirthday1" placeholder="mm-dd-yyyy" value="" min="1899-01-01" max="2030-12-31" id="from-datepicker">
                                                    </div>
                                                </div>
                                                <div class="col-sm-1">
                                                    <div class="form-group">
                                                        <label>Age</label>
                                                        <input type="text" class="form-control" name="sage1">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Mobile Number</label>
                                                        <input type="text" class="form-control" name="smobileno1">
                                                    </div>
                                                </div>   
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="scitizen1">
                                                    </div>    
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Place of Birth</label>
                                                        <input type="text" class="form-control" name="splaceofbirth1">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="saddress1">
                                                    </div>    
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control h-100" name="shigheduc1">
                                                            <option>Choose...</option>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="soccu1">
                                                    </div>    
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Work Address</label>
                                                        <input type="text" class="form-control" name="sworkadd1">
                                                    </div>    
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Email</label>
                                                        <input type="text" class="form-control" name="semail1">
                                                    </div>    
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col mt-5">
                                                    <button class="btn btn-primary pull-right" name="suspectsave1" type="submit">Add Suspect Data</button>
