                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h2 class="header-title text-center text-uppercase">Victim Person List</h2> 
                                                <p class="text-danger text-center">Investigation no: <?php echo $crimesuslist; ?></p>   
                                            </div>
                                            <div class="col-sm-3">
                                                <a href="admin-victimadd.php" class="btn btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add Victim</a>    
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        <thead class="bg-my-secondary text-light">
                                            <tr>
                                                ...
                                                <th class="text-center">Victim Name</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_victim WHERE investigno = "'.$crimesuslist.'"');
                                                    ...
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3">
                                                            <form action="code.php" method="POST">
                                                                <input type="hidden" value="<?php echo $row["id"]; ?>" name="delvic2id">
                                                                <button  type="submit" class="text-danger border-0" name="delvic2"><i class="fa fa-trash" aria-hidden="true"></i> Delete</button>   
                                                            </form>
                                                        </li>
                                                    </ul>
                                                </td>
