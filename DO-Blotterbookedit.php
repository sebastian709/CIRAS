                            ...
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        ...
                                        $myid = $_SESSION['pbeditids'];
                                        $table = mysqli_query($conn,"SELECT * FROM tbl_blotter WHERE entryno = '$myid'");
                                    ...
                                    <div class="container-fluid">
                                        <form action="code.php" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <h4 class="text-center text-uppercase mb-5">Entry No: <?php echo $row["entryno"]; ?></h4>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col">
                                                                <p class="text-center">Date: <?php echo $row["bdate"]; ?></p>    
                                                            </div>  
                                                            <div class="col">
                                                                <p class="text-center">Time: <?php echo $row["btime"]; ?></p>
                                                            </div>   
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col">
                                                    <input type="hidden" value="<?php echo $row["entryno"]; ?>" name="inciid">
                                                    <label>Incidental/Events</label>
                                                    <textarea class="form-control" id="incidental" rows="5" name="ebevent"></textarea>

                                                    <script>
                                                        document.getElementById("incidental").value += '<?php echo $row["bincidentevent"]; ?>';
                                                    </script>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col">
                                                    ...
                                                    <textarea class="form-control" id="dispo" rows="5" name="ebdisposition"></textarea>

                                                    <script>
                                                        document.getElementById("dispo").value += '<?php echo $row["bdisposition"]; ?>';
                                                    </script>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col">
                                                    <button type="submit" class="btn=sm btn btn-primary pull-right form-control" name="pbeditdata">Submit</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
