                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col">
                                                <a href="admin-suspectlist.php" class="btn btn-danger pull"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back</a>      
                                            </div>
                                            <div class="col mb-5">
                                                <h2 class="text-center header-title">Suspect Recovery List</h3>    
                                            </div>
                                            <div class="col">
                                    ...
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_suspect WHERE sdeleted = "Yes"');
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $row["slastname"]; ?>, <?php echo $row["sfirstname"]; ?> <?php echo $row["smidname"]; ?></td>
                                                <td>
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="spdelete_id" id="delete_id">
                        <p>Are you sure to delete data permanently?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="spdeletedata" id="deletedata" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="restoremodal" tabindex="-1" role="dialog" aria-labelledy="exampleModallabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="srestore_id" id="restore_id">
                        <p>Are you sure to restore data?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="srestoredata" id="restoredata" class="btn btn-success">Restore</button>
                    </div>
                </form>
            </div>
        </div>
