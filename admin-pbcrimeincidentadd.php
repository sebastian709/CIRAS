        ...
        <div class="main-content">
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><a href="admin-policeblotterlist">Police Blotter</a></li>
                                <li><span>Add Crime Incident</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col pull-left mt-5">
                            <a href="admin-incident.php" class="btn btn-danger"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back</a>
                        </div>
                    </div>
