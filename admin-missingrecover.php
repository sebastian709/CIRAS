...
if (isset($_SESSION['ID']) && isset($_SESSION['NAME'])) {
  ...
  $results = mysqli_query($conn, "SELECT * FROM tbl_missing WHERE mdeleted = 'Yes'");
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col mb-4">
                                                <a href="admin-missinglist.php" class="btn btn-danger"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back</a>    
                                            </div>
                                            <div class="col">
                                                <h3 class="text-center header-title">Missing Recovery List</h3>    
                                            </div>
                                            <div class="col">
                                        ...
                                        <tbody>
                                            <?php foreach ($users as $user): ?>
                                              <tr class="text-center">
                                                <td class="p-5"> <?php echo $user['id']; ?> </td>
                                                <td > <img src="<?php echo 'images/' . $user['mprofile_image'] ?>" width="100" height="90" alt=""> </td>
                                                <td class="p-5"> <?php echo $user['mname']; ?> </td>
                                                <td class="p-5">
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="mpdelete_id" id="delete_id">
                        <p>Are you sure to delete data permanently?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="mpdeletedata" id="deletedata" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="mrestoredata" id="restoredata" class="btn btn-success">Restore</button>
                    </div>
                </form>
            </div>
        </div>
