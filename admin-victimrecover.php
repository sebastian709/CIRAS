                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col mb-5">
                                                <a href="admin-victimlist.php" class="btn btn-danger"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back</a>      
                                            </div>
                                            <div class="col">
                                                <h2 class="header-title text-center">Victim Recovery List</h2>    
                                            </div>
                                            <div class="col">
                                    ...
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_victim WHERE vdeleted = "Yes"');
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $row["vlastname"]; ?>, <?php echo $row["vfirstname"]; ?> <?php echo $row["vmidname"]; ?></td>
                                                <td>
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="vpdelete_id" id="delete_id">
                        <p>Are you sure to delete data permanently?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="vpdeletedata" id="deletedata" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="restoremodal" tabindex="-1" role="dialog" aria-labelledy="exampleModallabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="vrestore_id" id="restore_id">
                        <p>Are you sure to restore data?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="vrestoredata" id="restoredata" class="btn btn-success">Restore</button>
                    </div>
                </form>
            </div>
        </div>
