                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Crime Case Master</span></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col mb-3">
                                                <h2 class="header-title text-center">Crime Case List</h2>    
                                            </div>
                                            <div class="col">
                                                <a href="admin-crimereports.php" class="btn btn-success pull-right"><i class="fa fa-th-list" aria-hidden="true"></i> Completed cases</a>    
                                            </div>
                                        </div>
                                    </div>
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_irf WHERE isitcrime="Yes" AND status = "On-Going" ');
                                                ...
                                                { 
                                                  ...
                                                  ?>
                                            <tr>
                                                <td class="text-center"><?php echo $row["blotterno"]; ?></td>
                                                <td class="text-center"><a href="" class="text-dark"><?php echo $row["incitype"]; ?></a>
                                                </td>
                                                <td class="text-center"><a href="" class="text-dark"><?php echo $row["barangay"]; ?></a>
                                                </td>
                                                    ...
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3">
                                                            <form action="code.php" method="POST">
                                                                <input type="hidden" value="<?php echo $row["blotterno"]; ?>" name="addevidenceid">
                                                                <button class="mr-3 border-0 text-primary" name="addevidencebtn" type="submit"><i class="fa fa-paperclip" aria-hidden="true"></i> Add Evidence</button>    
                                                            </form>
                                                        ...
                                                        <li class="mr-3">
                                                            <form action="code.php" method="POST">
                                                                <input type="hidden" value="<?php echo $row["incitype"]; ?>" name="victimlisttype">
                                                                <input type="hidden" value="<?php echo $row["blotterno"]; ?>" name="victimlistid">
                                                                <button class="mr-3 border-0 text-info" name="victimlistbtn" type="submit"><i class="fa fa-users" aria-hidden="true"></i> Victim List</button>    
                                                            </form>
                                                        </li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <form action="code.php" method="POST">
                                                                <input type="hidden" value="<?php echo $row["incitype"]; ?>" name="suspectlisttype">
                                                                <input type="hidden" value="<?php echo $row["blotterno"]; ?>" name="suspectlistid">
                                                                <button class="mr-3 border-0 text-dark" name="suspectlistbtn" type="submit"><i class="fa fa-users" aria-hidden="true"></i> Suspect List</button>    
                                                            </form>
                                                        </li>
