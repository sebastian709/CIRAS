                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container-fluid">
                                        <form action="code.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" value="<?php echo $user['id']; ?>" name="daedit_id">
                                                                    <input type="text" class="form-control" name="dainvestigno" value="<?php echo $user['dinvestigno']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="dafullname" value="<?php echo $user['dfullname']; ?>">
                                                                </div>   
                                                            </div>
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    <label>Allias</label>
                                                                    <input type="text" class="form-control" name="danickname"value="<?php echo $user['dnickname']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="damobileno"value="<?php echo $user['dmobileno']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Address</label>
                                                                    <input type="text" class="form-control" name="daaddress" value="<?php echo $user['daddress']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="daoccupation" value="<?php echo $user['doccupation']; ?>">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Nationality</label>
                                                                    <input type="text" class="form-control" name="danationality" value="<?php echo $user['dnationality']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Weight</label>
                                                                    <input type="text" class="form-control" name="daweight" value="<?php echo $user['dweight']; ?>">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Height</label>
                                                                    <input type="text" class="form-control" name="daheight" value="<?php echo $user['dheight']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="dacoloreyes" value="<?php echo $user['dcoloreyes']; ?>">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Color Hair</label>
                                                                    <input type="text" class="form-control" name="dahair" value="<?php echo $user['dhair']; ?>">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Complexion</label>
                                                                    <input type="text" class="form-control" name="dacomplexion" value="<?php echo $user['dcomplexion']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" class="form-control" name="dadatereported" placeholder="mm-dd-yyyy" min="1899-01-01" max="2030-12-31" id="from-datepicker" value="<?php echo $user['ddatereported']; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Date of Birth</label>
                                                                    <input type="date" class="form-control" name="dadateofbirth" placeholder="mm-dd-yyyy" min="1899-01-01" max="2030-12-31" id="from-datepicker" value="<?php echo $user['ddateofbirth']; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="daplaceofbirth" value="<?php echo $user['dplaceofbirth']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="daworkadd" value="<?php echo $user['dworkadd']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="daafppnprank" value="<?php echo $user['dafppnprank']; ?>">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Unit Assignment</label>
                                                                    <input type="text" class="form-control" name="daunitassign" value="<?php echo $user['dunitassign']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="dagroupaff" value="<?php echo $user['dgroupaff']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="dadescripteyes" value="<?php echo $user['ddescripteyes']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="dadescripthair" value="<?php echo $user['ddescripthair']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="dacontactname" value="<?php echo $user['dcontactname']; ?>">
                                                                </div>   
                                                            </div>
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    <label>Relationship</label>
                                                                    <input type="text" class="form-control" name="darelationship" value="<?php echo $user['drelationship']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="darelcontactno" value="<?php echo $user['drelcontactno']; ?>">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Email</label>
                                                                    <input type="text" class="form-control" name="daemail" value="<?php echo $user['demail']; ?>">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col mt-5">
                                                    <button class="btn btn-primary pull-right" name="drugarredit" type="submit">Edit data</button>
