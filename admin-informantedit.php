                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="admin-informantlist.php"  class="text-light">Informant</a></li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Informant Master</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php">Home</a></li>
                                <li><a href="admin-informantlist.php">Informant Master</a></li>
                                <li><span></span>Edit Informant's Data</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="admin-informantlist.php" class="btn btn-danger">Back</a>   
                        </div>   
                    </div>
                    <div class="row">
                        <div class="col mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        ...
                                        $table = mysqli_query($conn,"SELECT * FROM tbl_informant WHERE id = '$myid'");
                                    ...
                                    ?>
                                    <h2 class="header-title text-center"><?php echo $row["ilastname"]; ?>'s Data</h2>
                                    <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ielastname" value="<?php echo $row["ilastname"]; ?>">
                                                    </div>    
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>First name</label>
                                                        <input type="text" class="form-control" name="iefirstname" value="<?php echo $row["ifirstname"]; ?>">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Middle name</label>
                                                        <input type="text" class="form-control" name="iemidname" value="<?php echo $row["imidname"]; ?>">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Nickname</label>
                                                        <input type="text" class="form-control" name="ienickname" value="<?php echo $row["inickname"]; ?>">
                                                    </div>
                                                </div>  
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control h-100" name="iecivilstatus">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        <label>Gender</label>
                                                        <select class="form-control h-100" name="iegender" value="<?php echo $row["igender"]; ?>">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="iebirthday" placeholder="mm-dd-yyyy" value="<?php echo $row["ibirthday"]; ?>" min="1899-01-01" max="2030-12-31" id="from-datepicker">
                                                    </div>
                                                </div>
                                                <div class="col-sm-1">
                                                    <div class="form-group">
                                                        <label>Age</label>
                                                        <input type="text" class="form-control" name="ieage" value="<?php echo $row["iage"]; ?>">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Mobile Number</label>
                                                        <input type="text" class="form-control" name="iemobileno" value="<?php echo $row["imobileno"]; ?>">
                                                    </div>
                                                </div>   
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="iecitizen" value="<?php echo $row["icitizen"]; ?>">
                                                    </div>    
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Place of Birth</label>
                                                        <input type="text" class="form-control" name="ieplaceofbirth" value="<?php echo $row["iplaceofbirth"]; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ieaddress" value="<?php echo $row["iaddress"]; ?>">
                                                    </div>    
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control h-100" name="iehigheduc" value="<?php echo $row["ihigheduc"]; ?>">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ieoccu" value="<?php echo $row["ioccu"]; ?>">
                                                    </div>    
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Work Address</label>
                                                        <input type="text" class="form-control" name="ieworkadd" value="<?php echo $row["iworkadd"]; ?>">
                                                    </div>    
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Email</label>
                                                        <input type="text" class="form-control" name="ieemail" value="<?php echo $row["iemail"]; ?>">
                                                    </div>    
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col mt-5">
                                                    <button class="btn btn-primary pull-right" name="einformantsave" type="submit">Update Data</button>
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="admin-informantlist.php" class="btn btn-danger">Discard</a>
                    </div>
                </form>
            </div>
        </div>
