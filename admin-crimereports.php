                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col mb-5">
                                                 <h2 class="header-title text-center">Sort by barangay</h2>    
                                            </div>
                                            <div class="col">
                                        ...
                                        <form action="code.php" method="POST">
                                            <div class="row">
                                                <div class="col form-group">
                                                    ...
                                                    <select class="form-control" name="chooseinp">
                                                        <option selected="" readonly="">Choose...</option>
                                                        <option>All (Sto.Tomas)</option>
                                                ...
                                                <div class="col form-group mt-1">
                                                    <label></label>
                                                    <button type="submit" class="btn btn-success form-control" name="reloadbtn">Reload</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col mb-2">
                                                ...
                                                <p class="text-center text-danger">Barangay: <?php echo $cbtn; ?></p>
                                            </div>
                                            <div class="col">   
                                            </div>
                                        </div>
                                    ...
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                if ($cbtn == "All (Sto.Tomas)") {
                                                       $table = mysqli_query($conn,"SELECT * FROM tbl_irf WHERE isitcrime='Yes' AND status = 'Completed' ");
                                                }else{
                                                     $table = mysqli_query($conn,"SELECT * FROM tbl_irf WHERE isitcrime='Yes' AND status = 'Completed' AND barangay = '".$cbtn."' ");    
                                                }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><a href="#" class="text-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Export Report To PDF </a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                                <?php
                                ...
                                <form method="post" action="generate_pdf.php">
                                    <div class="card-body">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col form-group">
                                                    <button type="submit" class="btn btn-danger form-control" name="generate_pdf"><i class="fa fa-print" aria-hidden="true"></i> Print Reports</button>
                                                </div>
                                            </div>
                                        </div>    
                                    </div>
