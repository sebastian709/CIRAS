                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Informant Master</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col mb-5">
                                            <h2 class="header-title text-center">Reporting Person List</h2>    
                                        </div>
                                        <div class="col">
                                            <a href="admin-informantrecover.php" class="btn btn-success pull-right"><i class="fa fa-recycle" aria-hidden="true"></i> Data Recovery</a>    
                                        </div>
                                    </div>
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_informant WHERE ideleted = "No"');
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="" class="text-dark"><?php echo $row["ilastname"]; ?>, <?php echo $row["ifirstname"]; ?> <?php echo $row["imidname"]; ?></a></td>
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <form action="code.php" method="POST">
                                                            <input type="hidden" name="ipassdataid" value="<?php echo $row["id"]; ?>">
                                                            <button class="mr-3 border-0 text-primary" name="ipassdatabtn" type="submit"><i class="fa fa-edit"></i> Edit</button>
                                                        </form>
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="idelete_id" id="delete_id">
                        <p>Are you sure to delete data?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="ideletedata" id="deletedata" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
