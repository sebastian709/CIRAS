        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <h3 class="mt-5 text-center">Add Informant</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="header-title text-center">Informant Data</h2>
                                    <div class="container-fluid">
                                        <form action="code.php" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col mt-5">
                                                    <button class="btn btn-primary pull-right" name="Informantsave" type="submit">Add Informant Data</button>
