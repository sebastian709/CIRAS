                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="main-dashboard.php"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>

                            <li ><a href="main-incident.php"><i class="fa fa-file-text text-light" aria-hidden="true"></i> <span>Add Incident Type</span></a></li>
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col mb-2">
                                                <a href="#" class="btn btn-info pull-left deletebtn"><i class="fa fa-user-plus" aria-hidden="true"></i> Registration Pass</a>    
                                            </div>
                                            <div class="col">
                                                <h2 class="header-title text-center">Accounts</h2>    
                                            </div>
                                            <div class="col mb-4">     
                                            </div>
                                        </div>
                                    ...
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_accounts');
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="" class="text-dark"><?php echo $row["username"]; ?></a></td>
                                                <td class="text-center"><a href="" class="text-dark"><?php echo $row["status"]; ?></a></td>
                                                <td class="text-center"><a href="" class="text-dark"><?php echo $row["acclvl"]; ?></a></td>
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <form method="POST" action="code.php">
                                                            <li class="mr-3">
                                                                <input type="hidden" value="<?php echo $row["id"]; ?>" name="delregid">
                                                                <button class="text-danger deletebtn border-0" name="delreg"><i class="ti-trash"></i> Delete </button>
                                                            </li>    
                                                        </form>
                                                    </ul>
                                                </td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Registration Account</h5>
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <select class="form-control" name="acclvl">
