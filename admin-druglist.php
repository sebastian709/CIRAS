                        ...
                        <div class="col mt-5">
                            <ul class="nav nav-tabs nav-justified">
                              <li class="nav-item bg-my-secondary">
                                <a class="nav-link active text-warning font-weight-bold border border-dark" data-toggle="tab" href="#arrested">DRUG WATCHLIST</a>
                              </li>
                              <li class="nav-item bg-my-secondary">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col text-center text-light">
                                                <a href="admin-drugarradd.php" class="btn btn-primary pull-left">Add Drug Case</a>
                                                <h2 class="btn btn-warning text-light font-weight-bold">On Going</h2>
                                                <h2 class="btn btn-success text-light font-weight-bold">Completed</h2>
                                        ...
                                        <div class="row">
                                            <div class="col mt-5">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h2 class="header-title text-center">DRUG WATCHLIST</h2>
                                ...
                                <div class="tab-pane container fade" id="surrendered">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col text-center text-light">
                                                <a href="admin-drugsurradd.php" class="btn btn-primary pull-left">Add Drug Case</a>
                                                <h2 class="btn btn-danger text-light font-weight-bold">Rehabilitate</h2>
                                                <h2 class="btn btn-success text-light font-weight-bold">Completed</h2>
                                                <a href="admin-drugrecover.php" class="btn btn-danger pull-right"><i class="fa fa-recycle" aria-hidden="true"></i> Data Recovery</a>    
                                            </div>   
                                        </div>
                                        <div class="row">
                                            <div class="col mt-5">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h2 class="header-title text-center">SURRENDERED DRUG CASE LIST</h2>
