...
if (isset($_SESSION['ID']) && isset($_SESSION['NAME'])) {
  ...
  $results = mysqli_query($conn, "SELECT * FROM tbl_missing WHERE mdeleted = 'No'");
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Missing Master</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col">
                                                <a href="admin-missingadd.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add Missing</a>    
                                            </div>
                                            <div class="col">
                                                <h2 class="header-title text-center">Missing List</h2>    
                                            </div>
                                            <div class="col mb-3">
                                                <a href="admin-missingrecover.php" class="btn btn-success pull-right"><i class="fa fa-recycle" aria-hidden="true"></i> Data Recovery</a>    
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <form action="code.php" method="POST">
                                                            <input type="hidden" name="mpassdataid" value="<?php echo $user["id"]; ?>">
                                                            <button class="mr-3 border-0 text-primary" name="mpassdatabtn" type="submit"><i class="fa fa-edit"></i> Edit</button>
                                                        </form>
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="mdelete_id" id="delete_id">
                        <p>Are you sure to delete data?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="mdeletedata" id="deletedata" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
