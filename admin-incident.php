                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Incident Record</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Incident Record</span></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h2 class="header-title text-center">INCIDENT LIST</h2>    
                                            </div>
                                            <div class="col mb-4">
                                                 <a href="admin-incidentrecover.php" class="btn btn-success pull-right"><i class="fa fa-recycle" aria-hidden="true"></i> Data Recovery</a>     
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                       <?php
                                        $sname = "localhost";
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_irf WHERE isitcrime="No" ');
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="" class="text-dark"><?php echo $row["incitype"]; ?></a></td>
                                                
                                                <td>
                                                    <ul class="d-flex justify-content-center">

                                                        <li class="mr-3"><a href="admin-crimeaddevidence.php" class="text-success"><i class="fa fa-paperclip" aria-hidden="true"></i> Add Evidence </a></li>
                                                        <li class="mr-3"><a href="#" class="text-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Export Report To PDF </a></li>
                                                        <li class="mr-3"><a href="admin-crimesuspectlist.php" class="text-dark"><i class="fa fa-users" aria-hidden="true"></i> Suspect List </a></li>
                                                         <li class="mr-3"><a href="admin-crimesuspectlist.php" class="text-dark"><i class="fa fa-users" aria-hidden="true"></i> Victim List </a></li>
