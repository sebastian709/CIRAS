                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>SUSPECT PERSON LIST</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h2 class="header-title text-center text-uppercase">Suspect Person List</h2> 
                                                <p class="text-danger text-center">Investigation no: <?php echo $crimesuslist; ?></p>   
                                            </div>
                                            <div class="col-sm-3">
                                                <a href="admin-suspectadd.php" class="btn btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add Suspect</a>    
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                                        <thead class="bg-my-secondary text-light">
                                            <tr>
                                                ...
                                                <th class="text-center">Suspect Name</th>
                                                <th class="text-center">Suspect Status</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_suspect WHERE investigno = "'.$crimesuslist.'"');
                                                    ...
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3">
                                                            ...
                                                            <form action="code.php" method="POST">
                                                                <input type="hidden" value="<?php echo $row["id"]; ?>" name="suspectid">
                                                                <input type="hidden" value="<?php echo $crimesuslist; ?>" name="bookarrid">
                                                                <button target="__blank"  type="submit" class="text-success border-0" name="bookarrbtn"><i class="fa fa-book" aria-hidden="true"></i> Book arrest</button>   
                                                            </form>
                                                            <?php } ?>
                                                        </li>
                                                        <li class="mr-3">
                                                            <?php if($row['status']!='At-large'){?>
                                                            <h4 class="text-center" target="__blank"><i class="fa fa-lg fa-check-square text-success" aria-hidden="true"></i></h4>
                                                            <?php } ?>
                                                        </li>
                                                    </ul>
                                                </td>
                    ...
                    <div class="row">
                        <div class="col mt-5">
                            <div class="card">
                                <h4 class="header-title text-center mt-4">Crime Case Solved</h4>
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col form-group">
                                                <form action="code.php" method="POST">
                                                    <input type="hidden" value="<?php echo $crimesuslist; ?>" name="forcompleteid">
                                                    <button type="submit" class="btn btn-success form-control" name="forcompletebtn">Complete</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
