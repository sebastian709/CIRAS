                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Police Blotter</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>List of Incident</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col mt-5">
                            <ul class="nav nav-tabs nav-justified">
                              <li class="nav-item bg-my-secondary">
                                <a class="nav-link active text-warning font-weight-bold border border-dark" data-toggle="tab" href="#arrested">CRIME INCIDENT</a>
                              </li>
                              <li class="nav-item bg-my-secondary">
                                <a class="nav-link text-warning font-weight-bold border border-dark" data-toggle="tab" href="#surrendered">MISSING PERSON</a>
                              </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col text-center text-light mt-5">
                                                <a href="admin-pbcrimeincidentadd.php" class="btn btn-primary pull-left">Add Crime Incident</a>
                                                <a href="admin-drugrecover.php" class="btn btn-danger pull-right"><i class="fa fa-recycle" aria-hidden="true"></i> Data Recovery</a>    
                                            </div>   
                                        </div>
                                        <div class="row">
                                            <div class="col mt-5">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h2 class="header-title text-center">CRIME INCIDENT LIST</h2>
                                                        <table id="example" class="table table-striped table-bordered" style="width:100%">
                                                            <thead class="bg-my-secondary text-light">
                                                                <tr>
                                                                    <th class="text-center">Blotter Enty No.</th>
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    ...
                                                                    $table = mysqli_query($conn,'SELECT * FROM tbl_drug WHERE ddeleted = "No" AND dtype = "arrested"');
                                                                    ...
                                                                    <td>
                                                                        <ul class="d-flex justify-content-center">
                                                                            <form action="code.php" method="POST">
                                                                                <input type="hidden" name="dpassdataid" value="<?php echo $row["id"]; ?>">
                                                                                <button class="mr-3 border-0 text-primary" name="dpassdatabtn" type="submit"><i class="fa fa-edit"></i> Edit</button>
                                                                            </form>
                                ...
                                <div class="tab-pane container fade" id="surrendered">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col text-center text-light mt-5">
                                                <a href="admin-drugsurradd.php" class="btn btn-primary pull-left">Add Missing Incident</a>
                                                <a href="admin-drugrecover.php" class="btn btn-danger pull-right"><i class="fa fa-recycle" aria-hidden="true"></i> Data Recovery</a>    
                                            </div>   
                                        </div>
                                        <div class="row">
                                            <div class="col mt-5">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h2 class="header-title text-center">MISSING INCIDENT LIST</h2>
                                                        <table id="example2" class="table table-striped table-bordered" style="width:100%">
                                                            <thead class="bg-my-secondary text-light">
                                                                <tr>
                                                                    <th class="text-center">ID</th>
                                                                    <th class="text-center">Missing Person</th>
                                                                    <th class="text-center">Reporting Person</th>
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    ...
                                                                    $table = mysqli_query($conn,'SELECT * FROM tbl_drug WHERE ddeleted = "No" AND dtype = "surrendered"');
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <ul class="d-flex justify-content-center">
                                                                            <li>
                                                                                <form action="code.php" method="POST">
                                                                                <input type="hidden" name="sdpassdataid" value="<?php echo $row["id"]; ?>">
                                                                                <button class="mr-3 border-0 text-primary" name="sdpassdatabtn" type="submit"><i class="fa fa-edit"></i> Edit</button>
                                                                            </form>    
                                                                            </li>
                                                                            <li class="mr-3">
                                                                                <a href="#" class="text-success"><i class="fa fa-user-plus" aria-hidden="true"></i> Missing</a>
                                                                            </li>
                                                                            <li class="mr-3">
                                                                                <a href="#" class="text-danger deletebtn"><i class="ti-trash"></i> Delete </a>
                                                                            </li>
                                                                        </ul>
                                                                    </td>
                                                                </tr>
            ...
            <div class="modal-content">
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="sddelete_id" id="delete_id">
                        <p>Are you sure to delete data?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="sddeletedata" id="deletedata" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
