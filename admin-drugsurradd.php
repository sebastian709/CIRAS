        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <h3 class="mt-5 text-center">ADD SURRENDERED PERSON INVOLVES IN DRUG CASE</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <form action="code.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col mb-2">
                                                                <p class="text-center font-weight-bold">SURRENDERED PERSON DETAILS</p>    
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdainvestigno">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdafullname">
                                                                </div>   
                                                            </div>
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    <label>Allias</label>
                                                                    <input type="text" class="form-control" name="sdanickname">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdamobileno">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Address</label>
                                                                    <input type="text" class="form-control" name="sdaaddress">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdaoccupation">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Nationality</label>
                                                                    <input type="text" class="form-control" name="sdanationality">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Weight</label>
                                                                    <input type="text" class="form-control" name="sdaweight">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Height</label>
                                                                    <input type="text" class="form-control" name="sdaheight">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdacoloreyes">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Color Hair</label>
                                                                    <input type="text" class="form-control" name="sdahair">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Complexion</label>
                                                                    <input type="text" class="form-control" name="sdacomplexion">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" class="form-control" name="sdadatereported" placeholder="mm-dd-yyyy" value="" min="1899-01-01" max="2030-12-31" id="from-datepicker">
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Date of Birth</label>
                                                                    <input type="date" class="form-control" name="sdadateofbirth" placeholder="mm-dd-yyyy" value="" min="1899-01-01" max="2030-12-31" id="from-datepicker">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdaplaceofbirth">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdaworkadd">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdaafppnprank">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Unit Assignment</label>
                                                                    <input type="text" class="form-control" name="sdaunitassign">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdagroupaff">
                                                                </div>   
                                                            </div>
                                                            <?php
                                                                $og = "value ='<h2 class=\"btn btn-danger text-light font-weight-bold\"></h2>'";
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <label>Status</label>
                                                                    <select class="form-control h-100" name="sdastatus">
                                                                        <option>Choose...</option>
                                                                        <option <?php echo $og ?>>Rehabilitate</option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdadescripteyes">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdadescripthair">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdacontactname">
                                                                </div>   
                                                            </div>
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    <label>Relationship</label>
                                                                    <input type="text" class="form-control" name="sdarelationship">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sdarelcontactno">
                                                                </div>   
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Email</label>
                                                                    <input type="text" class="form-control" name="sdaemail">
                                                                </div>   
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col mt-5">
                                                    <button class="btn btn-primary pull-right" name="sdrugarrsave" type="submit">Add data</button>
